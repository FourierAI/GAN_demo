...
class G_CGAN(nn.Module):
    ...
    def __init__(self, noise_size=5, condition_size=10, latent_ratio=10, seq_size=50):
        super(G_CGAN, self).__init__()
        self.noise_size = noise_size
        self.condition_size = condition_size
        self.l1_in_size = self.noise_size + self.condition_size
    ...
    def forward(self, noise, condition):
        concatenate = torch.cat((noise, condition), 1)
